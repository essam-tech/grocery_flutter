    ...
    return Row(
      children: [
        CustomIconButton(
          width: 36.w,
          height: 36.h,
          onPressed: () => controller.onDecreasePressed(product.productId),
        ...
        GetBuilder<BaseController>(
          id: 'ProductQuantity',
          builder: (_) => Text(
            product.productQuantity.toString(), // الآن موجود
        ...
        CustomIconButton(
          width: 36.w,
          height: 36.h,
          onPressed: () => controller.onIncreasePressed(product.productId),
          icon: SvgPicture.asset(
            Constants.addIcon,
            fit: BoxFit.none,
          ),
